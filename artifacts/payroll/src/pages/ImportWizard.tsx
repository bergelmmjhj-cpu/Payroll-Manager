  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in slide-in-from-bottom-4">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-black mb-4">Excel Import Wizard</h1>
        <p className="text-xl text-muted-foreground">Import your MMJ Excel workbooks automatically.</p>
      </div>
      ...
      {step === 1 && (
        <Card className="p-16 border-dashed border-4 border-primary/20 bg-primary/5 flex flex-col items-center justify-center text-center relative overflow-hidden transition-colors hover:border-primary/50 hover:bg-primary/10">
          ...
          <p className="text-lg text-muted-foreground mb-8">Supports standard 25-sheet MMJ .xlsx files</p>
          ...
          <Card className="p-8 bg-emerald-50 border-emerald-200">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-lg text-emerald-700">Found {analysis.entryCount} entries across {analysis.workerCount} workers.</p>
              </div>
            </div>
